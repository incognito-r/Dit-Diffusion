...
class Unet(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.down_channels = config.get('down_channels', [32, 64, 128, 256])
        self.mid_channels = config.get('mid_channels', [256, 256, 128])
        self.down_sample = config.get('down_sample', [True, True, False])
        self.t_emb_dim = config.get('time_emb_dim', 128)
        self.num_down_layers = config.get('num_down_layers', 2)
        self.num_mid_layers = config.get('num_mid_layers', 2)
        self.num_up_layers = config.get('num_up_layers', 2)
